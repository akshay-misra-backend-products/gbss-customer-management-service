...
@Component
public class CustomerConverter implements Function<com.gbss.customer.rest.json.request.Customer,
        Customer> {
    ...
    @Override
    public Customer apply(com.gbss.customer.rest.json.request.Customer source) {
